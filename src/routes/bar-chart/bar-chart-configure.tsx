...
export default function BarChartConfigure() {
...
//   const [submitBtnDisabled, setSubmitBtnDisabled] = useState(false);
//   const expectedParams = ['title', 'data-label', 'x-axis-title', 'y-axis-title', 'y-axis-increment', 'data-labels-num'];
...
//         navigate(`/type/bar/inputs?${Object.keys(finalNavParams.current).map((key) => [key, finalNavParams.current[key]]).map((param) => `${param[0]}=${encodeURIComponent(param[1] as string)}`).join('&')}`);
//       }
//       else {
...
//             <div className='basis-full flex flex-wrap items-center mb-6'>
//               <label htmlFor='x-axis-title' className='pr-2 basis-full mb-1.5'>X-Axis Title</label>
//               <input type='text' id='x-axis-title' name='x-axis-title' value={navLinkParams['x-axis-title']} onChange={(e) => setNavLinkParams({...navLinkParams, 'x-axis-title': e.target.value})} className='basis-full rounded-full border-black border-solid border-2 px-2 py-[0.25rem]' required/>
//             </div>
//             <div className='basis-full flex flex-wrap items-center mb-6'>
//               <label htmlFor='y-axis-title' className='pr-2 basis-full mb-1.5'>Y-Axis Title</label>
//               <input type='text' id='y-axis-title' name='y-axis-title' value={navLinkParams['y-axis-title']} onChange={(e) => setNavLinkParams({...navLinkParams, 'y-axis-title': e.target.value})} className='basis-full rounded-full border-black border-solid border-2 px-2 py-[0.25rem]' required/>
//             </div>
//             <div className='basis-full flex flex-wrap items-center mb-6'>
//               <label htmlFor='y-axis-increment' className='pr-2 basis-full mb-1.5'>Y-Axis Increment</label>
//               <input type='number' min={1} id='y-axis-increment' name='y-axis-increment' value={navLinkParams['y-axis-increment']} onChange={(e) => { setNavLinkParams({...navLinkParams, 'y-axis-increment': e.target.value})}} className='basis-full rounded-full border-black border-solid border-2 px-2 py-[0.25rem]' required/>
//             </div>
//             <div className='basis-full flex flex-wrap items-center mb-6'>
